...
public class MainVectores {
	...
	public static void main(String[] args) {
		...
		//5.  Declarar un vector miVec2 [3] de tipo char y asignamos la letra 
		//'A' a las posiciones 0, 1; y a la posición 2 la letra 'B'
		// finalmente inprimir las posiciones 0 y 2
